function lungAnalysis(lung_jpg)

%Reads Image Files
Selected_Image = imread('lung.jpg'); %read picture 
...
median_filtering_Image = filter2(fspecial('average',3),greyscale_Method)/255; %Uses Noise Removal
